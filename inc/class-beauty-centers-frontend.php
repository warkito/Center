...
if(!class_exists('WP_Beauty_Center_Frontend')){
    ...
    class WP_Beauty_Center_Frontend{
        ...
        public  function get_center_meta_value($center_id,$shordcode){
            ...
            switch ($shordcode){
                ...
                case "emaillanding" :
                    $email= get_post_meta($center_id,'beauty_center_email',true);
                     $override = '<a href="mailto:' . ($email) . '">' . ($email) . '</a>';break;
            ...
            case "description_du_centre" :
                    $center_description= get_post_meta($center_id,'beauty_center_description',true);
                    $override=  $center_description ?? nl2br($center_description);break;
            }
        ...
        public function get_email_content($center_id){
